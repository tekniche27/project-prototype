  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl">
        ...
        {/* Total Points */}
        <div className="p-5 font-semibold text-black bg-white shadow-md rounded-lg flex items-center justify-between hover:shadow-lg transition-shadow duration-300">
          <div>
        ...
        {/* Final Score */}
        <div className="p-5 font-semibold text-black bg-white shadow-md rounded-lg flex items-center justify-between col-span-1 md:col-span-3 text-center hover:shadow-lg transition-shadow duration-300">
          <p className="text-xl font-semibold w-full">
            You scored {correctAnswers} out of {totalQuestions} points!
          </p>
        </div>
      </div>
      <Link href='/'>
